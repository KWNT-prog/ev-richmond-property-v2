    ...
    return (
      <div className="pt-32 pb-24 min-h-screen bg-background text-center">
        ...
        <Link href="/properties">
          <Button className="bg-[#c9a96e] hover:bg-[#b89555] text-white border-[#c9a96e]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-10">
              ...
              >
                <div className="flex items-start justify-between flex-wrap gap-4 mb-4">
                  <div>
                    <div className="inline-block bg-[#c9a96e]/10 text-[#c9a96e] px-3 py-1 rounded-full text-xs uppercase tracking-widest font-sans mb-3 border border-[#c9a96e]/20">
                      {property.type}
                    </div>
                  ...
                  <div className="flex gap-2">
                    <button className="p-2 rounded-full border border-[#c9a96e]/20 hover:bg-[#c9a96e]/10 transition-colors">
                ...
                <div className="flex items-center text-muted-foreground font-sans mb-6">
                  <MapPin className="w-5 h-5 mr-2 text-[#c9a96e]" />
                  {property.address}
                </div>

                <div className="text-4xl font-display text-[#c9a96e] mb-8">
              ...
              >
                {[
                  ...
                  <div key={idx} className="bg-white border border-[#c9a96e]/15 rounded-xl p-4 text-center shadow-sm">
                    <stat.icon className="w-5 h-5 text-[#c9a96e] mx-auto mb-2" />
            ...
            >
              <div className="sticky top-28 space-y-6">
                <div className="bg-white border border-[#c9a96e]/15 rounded-2xl p-8 shadow-sm">
                  ...
                  <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                    <input
                      ...
                      className="w-full bg-[#f5f0e8] border border-[#c9a96e]/15 rounded-lg px-4 py-3 text-sm font-sans focus:outline-none focus:border-[#c9a96e]/40"
                    />
                    <input
                      type="email"
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#f5f0e8] border border-[#c9a96e]/15 rounded-lg px-4 py-3 text-sm font-sans focus:outline-none focus:border-[#c9a96e]/40 resize-none"
                      defaultValue={`I am interested in ${property.title}`}
                    />
                    <Button className="w-full bg-[#c9a96e] hover:bg-[#b89555] text-white border-[#c9a96e]">
                ...
                <div className="bg-white border border-[#c9a96e]/15 rounded-2xl p-8 shadow-sm">
                  ...
                  <div className="space-y-4 font-sans">
                    <a href="tel:+905550000000" className="flex items-center gap-3 text-muted-foreground hover:text-[#c9a96e] transition-colors">
                      <Phone className="w-5 h-5 text-[#c9a96e]" />
                      <span className="text-sm">+90 555 000 0000</span>
                    </a>
                    <a href="mailto:info@evrichmond.com" className="flex items-center gap-3 text-muted-foreground hover:text-[#c9a96e] transition-colors">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {similarProperties.map((p) => (
                  <Link key={p.id} href={`/properties/${p.id}`}>
                    <motion.div 
                      whileHover={{ y: -4 }}
                      className="bg-white rounded-xl overflow-hidden border border-[#c9a96e]/15 hover:border-[#c9a96e]/40 shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer"
                    >
                      <div className="relative aspect-[4/3] overflow-hidden">
                        ...
                        />
                        <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-2 py-1 rounded text-[#c9a96e] font-display text-xs border border-[#c9a96e]/20">
                          {p.type}
                        </div>
                      </div>
                      <div className="p-5">
                        <div className="flex items-center text-muted-foreground text-xs mb-1.5 font-sans">
                          <MapPin className="w-3 h-3 mr-1 text-[#c9a96e]" />
                          {p.location}
                        </div>
                        <h3 className="font-display text-foreground text-lg mb-2">{p.title}</h3>
                        <div className="text-xl font-display text-[#c9a96e]">{formatPrice(p.price)}</div>
                        <div className="flex items-center gap-4 mt-3 pt-3 border-t border-[#c9a96e]/10 text-muted-foreground text-xs font-sans">
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-2">
            {galleryImages.map((_, idx) => (
              <button
                ...
                className={`w-2.5 h-2.5 rounded-full transition-colors ${idx === activeImage ? 'bg-[#c9a96e]' : 'bg-white/40'}`}
              />
            ))}
          </div>
        </div>
